...
from transformers import WhisperModel, WhisperConfig # type: ignore[attr-defined]
...
def load_causal_whisper(model_name: str = "openai/whisper-base", device: str = "cuda"):
